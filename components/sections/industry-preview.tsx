...
import { ArrowUpLeft, ArrowUpRight, Building2, HeartPulse, PackageCheck, ShoppingBag, Store, UtensilsCrossed } from 'lucide-react';
import { industrySolutions } from '@/lib/industry-solutions';
import type { Locale } from '@/lib/i18n';

const selected = ['real-estate', 'restaurant-pos', 'healthcare', 'retail-ecommerce', 'logistics-delivery', 'professional-services'] as const;
const icons = { 'real-estate': Building2, 'restaurant-pos': UtensilsCrossed, healthcare: HeartPulse, 'retail-ecommerce': ShoppingBag, 'logistics-delivery': PackageCheck, 'professional-services': Store } as const;
  ...
  return (
    <section id="industries" className="section-padding border-y border-surface-border bg-surface-card/30">
      <div className="container-max px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid overflow-hidden rounded-3xl border border-surface-border bg-surface-border md:grid-cols-2 lg:grid-cols-3">
